...
public class RepoBlurbMap implements BlurbMap{
    ...
    /**
     * Returns a copy of the mappings in the {@code RepoBlurbMap}.
     *
     * @return a copy of the mappings in the {@code RepoBlurbMap}.
     */
    ...
    /**
     * Adds a key-value record into the {@code RepoBlurbMap}.
     *
     * @param key Key value.
